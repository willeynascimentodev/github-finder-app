...
function User() {
    const { user, showUser, repos, getUserRepos, loading } = useContext(GithubContext)
                    ...
                    <div className="col-span-2">
                        <div className="mb-6">
                            <h1 className="text-3xl card-title">
                                { name }
                                <div className="ml-2 mr badge badge-success">
                                    { type }
                                </div>
                                { hireable && (
